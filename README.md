...
| Finding | Town | England and Wales (2021) |
|---|---|---|
| Adults who are likely commuters | 79.2% | n/a |
| Unemployment rate | 8.75% | 4.3% |
| People per household | 2.60 | 2.4 |
| Largest age band | 35-39, then 40-44 | n/a |
| School-age share | 17.79% | n/a |
...
The census-analysis folder holds two files. census.ipynb has the cleaning, analysis and visualisation. FUNDAMENTALS OF DATA SCIENCE PROJECT.pdf is the full written report.
